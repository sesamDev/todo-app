...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  box-sizing: border-box;\n}\n\n:root {\n  --header-bg-color: rgb(197, 84, 67);\n  --header-title-color: rgb(255, 255, 255);\n  --side-panel-bg-color: rgb(250, 250, 250);\n  --main-content-bg-color: rgb(254, 254, 254);\n  --side-panel-items-color: rgb(110, 110, 110);\n  font-family: \"Roboto\", sans-serif;\n}\n\nbody {\n  height: 100vh;\n  width: 100vw;\n  position: relative;\n  display: grid;\n  grid-template-rows: 0.07fr 1fr;\n  grid-template-columns: 0.3fr 1fr;\n}\n\n.hidden {\n  opacity: 0;\n}\n\n.header {\n  grid-row: 1 / 2;\n  grid-column: 1 / 3;\n  color: var(--header-title-color);\n  height: 100%;\n  background-color: var(--header-bg-color);\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n}\n\n.header > h1 {\n  margin-left: 1rem;\n}\n\n.side-panel {\n  grid-row: 2 / 3;\n  grid-column: 1 / 2;\n  width: 100%;\n  height: 100%;\n  padding: 1rem 0 0 1rem;\n  background-color: var(--side-panel-bg-color);\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n.side-panel > ul {\n  font-size: 1em;\n  list-style: none;\n  font-weight: 500;\n  width: 100%;\n  padding: 0;\n}\n\n#addProjectButton {\n  margin-top: 2rem;\n}\n\n#projectHeader {\n  margin: 0.5rem 0 0 0;\n  text-align: center;\n}\n\n#projectLi {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin: 0.5rem 0 0 0;\n  width: 100%;\n  font-size: 1.2em;\n  cursor: pointer;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n#projectLi:hover {\n  width: 100%;\n  background-color: rgb(236, 236, 236);\n  border-radius: 1rem;\n}\n\n#projectLi:active {\n  background-color: rgb(216, 216, 216);\n}\n\n#projectLi > span {\n  opacity: 20%;\n  position: relative;\n  top: 2px;\n  right: 2px;\n  align-self: flex-end;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n#projectLi > span:hover {\n  opacity: 100%;\n  position: relative;\n  top: 2px;\n  right: 2px;\n  align-self: flex-end;\n}\n/* Fixes a bug where the click event fires on children of deletebutton */\n#projectLi > span > * {\n  pointer-events: none;\n}\n\n.side-panel-button {\n  margin: 0.5rem 0 0 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 5px;\n  transform-origin: left top;\n  border: none;\n  background-color: transparent;\n  font-size: 1.1em;\n  cursor: pointer;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n.side-panel-button:hover {\n  transform: scale(1.1);\n}\n\n.side-panel-button:active {\n  font-size: 1.1em;\n  color: rgb(179, 179, 179);\n}\n\n.main-content {\n  grid-row: 2 / 3;\n  grid-column: 2 / 3;\n  background-color: var(--main-content-bg-color);\n  display: grid;\n  grid-template-rows: 100px repeat(auto-fit, 4.5rem);\n  width: 100%;\n}\n\n.main-content > h2 {\n  font-size: 2rem;\n  grid-row: 1 / 2;\n  grid-column: 1 / 2;\n  justify-self: center;\n  margin-top: 0.5rem;\n}\n\n.main-content > button {\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n  height: 30px;\n  width: 80px;\n  justify-self: center;\n  align-self: flex-end;\n  border-radius: 0.5rem;\n  background-color: var(--side-panel-bg-color);\n  font-weight: bold;\n}\n\n#task > input[type=\"text\"] {\n  grid-column: 2 / 3;\n  position: absolute;\n  border-radius: 0.2rem;\n  padding-left: 0.5rem;\n}\n#task > input[type=\"date\"] {\n  grid-column: 3/4;\n  position: absolute;\n  right: 70px;\n}\n\n#task > h3 {\n  width: max-content;\n  cursor: pointer;\n  align-self: center;\n  position: relative;\n}\n\n#task > #taskDate {\n  width: max-content;\n  cursor: pointer;\n}\n\n#task > #taskDeleteButton {\n  height: 24px;\n  cursor: pointer;\n}\n\n/* Fixes a bug where the click event fires on children of deletebutton */\n#taskDeleteButton > * {\n  pointer-events: none;\n}\n\n#task {\n  background: rgb(255, 255, 255);\n  background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, rgba(250, 250, 250, 1) 42%);\n  border-radius: 0.5rem;\n  margin: 0.5rem 4rem;\n  border: 1px solid rgba(128, 128, 128, 0.1);\n  display: grid;\n  grid-template-columns: 1em auto max-content max-content;\n  padding: 0 0.5rem;\n  align-items: center;\n  gap: 10px;\n  height: 4rem;\n  transition: all linear 0.5sec;\n}\n\n#task:hover {\n  background-color: rgba(228, 228, 228, 0.462);\n}\n\n.hide {\n  display: none;\n}\n\n#addTaskButton {\n  grid-row: 1 / 2;\n  grid-column: 1 / 2;\n  height: 50px;\n  width: 50px;\n  background-color: var(--side-panel-bg-color);\n  color: var(--side-panel-items-color);\n  font-size: 3rem;\n  border-radius: 50%;\n  margin: 1rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: 1px solid rgb(216, 216, 216);\n}\n\n#addTaskButton:hover {\n  border: 1px solid rgb(121, 121, 121);\n  background-color: rgb(149, 149, 149);\n  color: white;\n}\n\n#addTaskButton:active {\n  border: 1px solid rgb(216, 216, 216);\n  background-color: var(--side-panel-bg-color);\n  color: var(--side-panel-items-color);\n}\n\n.todo-item {\n  background-color: var(--side-panel-bg-color);\n  width: 80%;\n  height: auto;\n  border-radius: 0.5rem;\n  box-shadow: 3px 3px 9px 0px rgba(0, 0, 0, 0.5);\n  -webkit-box-shadow: 3px 3px 9px 0px rgba(0, 0, 0, 0.5);\n  -moz-box-shadow: 3px 3px 9px 0px rgba(0, 0, 0, 0.5);\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(3, 1fr);\n  color: var(--side-panel-items-color);\n  padding: 0.5rem;\n  margin: 0 auto 0 auto;\n  overflow: hidden;\n  margin-top: 0.5rem;\n}\n\n.todo-item:hover {\n  background-color: rgb(255, 255, 255);\n}\n\n.todo-item > h3 {\n  color: black;\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n}\n\n.todo-item > p:nth-child(2) {\n  grid-column: 1 / 2;\n  grid-row: 2 / 4;\n}\n\n.todo-item > p:nth-child(3) {\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  text-align: end;\n}\n\n.todo-item > p:nth-child(4) {\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  text-align: end;\n}\n\n.todo-item > p:nth-child(5) {\n  height: 24px;\n  width: 24px;\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  margin-left: 80%;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n.todo-item > p:nth-child(5):hover {\n  transform: scale(1.1);\n  color: rgb(49, 49, 49);\n}\n\n.todo-item > p:nth-child(5):active {\n  font-size: 1.1em;\n  color: rgb(179, 179, 179);\n}\n\n.todo-item > p:nth-child(6) {\n  width: 24px;\n  height: 24px;\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  margin-left: 90%;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n.todo-item > p:nth-child(6):hover {\n  transform: scale(1.1);\n  color: rgb(49, 49, 49);\n}\n\n.todo-item > p:nth-child(6):active {\n  font-size: 1.1em;\n  color: rgb(179, 179, 179);\n}\n\n.todo-item > p > svg {\n  fill: green;\n}\n\n.form-container {\n  --form-height: 300px;\n  --form-width: 625px;\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(2, 1fr);\n  position: absolute;\n  background-color: var(--side-panel-bg-color);\n  height: var(--form-height);\n  width: var(--form-width);\n  top: 200px;\n  right: calc(100vw / 2 - calc(var(--form-width) / 2));\n  border-radius: 0.5rem;\n  box-shadow: 8px 7px 14px 0px rgba(133, 133, 133, 0.75);\n  -webkit-box-shadow: 8px 7px 14px 0px rgba(133, 133, 133, 0.75);\n  -moz-box-shadow: 8px 7px 14px 0px rgba(133, 133, 133, 0.75);\n}\n\nform {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: 0.5fr 1fr 1fr;\n  grid-row: 1 / 3;\n  grid-column: 1 / 3;\n}\n\nform > h2 {\n  margin: 1rem 1rem;\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n  color: var(--side-panel-items-color);\n}\n\nform > input[type=\"text\"] {\n  font-size: 1.2rem;\n  border-radius: 0.5rem;\n  border: none;\n  padding-left: 1rem;\n  width: 300px;\n  height: 50px;\n  grid-column: 1 / 2;\n  grid-row: 2 / 3;\n  margin-left: 1rem;\n}\n\nform > input[type=\"text\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > textarea {\n  resize: none;\n  grid-column: 1 / 2;\n  grid-row: 3 / 4;\n  height: 150px;\n  margin: 0 0 1rem 1rem;\n  border: none;\n  padding: 1rem 0 0 1rem;\n}\n\nform > textarea:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > label {\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  margin: 1.5rem 0 0 3.5rem;\n  color: var(--side-panel-items-color);\n}\n\nform > input[type=\"date\"] {\n  padding-left: 1rem;\n  border-radius: 0.5rem;\n  border: none;\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  height: 35px;\n  width: 150px;\n  margin: 1rem 0 0 8rem;\n}\n\nform > input[type=\"date\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > input[name=\"urgency\"] {\n  border-radius: 0.5rem;\n  border: none;\n  padding-left: 1rem;\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  height: 35px;\n  width: 150px;\n  margin: 0rem 0 0 8rem;\n}\n\nform > input[name=\"urgency\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > input[name=\"parentProject\"] {\n  grid-column: 2/3;\n  grid-row: 2 / 3;\n  border-radius: 0.5rem;\n  border: none;\n  padding-left: 1rem;\n  height: 35px;\n  width: 150px;\n  margin: 3rem 0 0 8rem;\n}\n\nform > input[name=\"parentProject\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\n#submit-button {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  height: 35px;\n  width: 150px;\n  margin: 3rem 0 0 8rem;\n  background-color: var(--header-bg-color);\n  color: white;\n  font-size: 1.1rem;\n  border-radius: 0.5rem;\n}\n\n#submit-button:hover {\n  background-color: rgb(59, 180, 93);\n}\n\nform > input[type=\"button\"] {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  height: 35px;\n  width: 150px;\n  margin: 6rem 0 0 8rem;\n  color: black;\n  font-size: 1.1rem;\n  border-radius: 0.5rem;\n  background-color: whitesmoke;\n}\n\nform > input[type=\"button\"]:hover {\n  background-color: rgb(180, 48, 48);\n}\n\n.project-input {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n#projectInputField {\n  font-size: 1rem;\n  height: 2rem;\n  width: 100%;\n  margin: 0.5rem 0 0.5rem 0;\n  padding: 0 0 0 1rem;\n}\n\n.side-panel > ul:nth-child(1) {\n  margin-top: 2rem;\n  height: 25%;\n}\n\n.side-panel > ul > li {\n  margin-top: 0.5rem;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,SAAS;EACT,sBAAsB;AACxB;;AAEA;EACE,mCAAmC;EACnC,wCAAwC;EACxC,yCAAyC;EACzC,2CAA2C;EAC3C,4CAA4C;EAC5C,iCAAiC;AACnC;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,kBAAkB;EAClB,aAAa;EACb,8BAA8B;EAC9B,gCAAgC;AAClC;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,gCAAgC;EAChC,YAAY;EACZ,wCAAwC;EACxC,aAAa;EACb,mBAAmB;EACnB,2BAA2B;AAC7B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,sBAAsB;EACtB,4CAA4C;EAC5C,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,cAAc;EACd,gBAAgB;EAChB,gBAAgB;EAChB,WAAW;EACX,UAAU;AACZ;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,oBAAoB;EACpB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,oBAAoB;EACpB,WAAW;EACX,gBAAgB;EAChB,eAAe;EACf,yBAAyB;EACzB,8BAA8B;EAC9B,iCAAiC;AACnC;;AAEA;EACE,WAAW;EACX,oCAAoC;EACpC,mBAAmB;AACrB;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,QAAQ;EACR,UAAU;EACV,oBAAoB;EACpB,yBAAyB;EACzB,8BAA8B;EAC9B,iCAAiC;AACnC;AACA;EACE,aAAa;EACb,kBAAkB;EAClB,QAAQ;EACR,UAAU;EACV,oBAAoB;AACtB;AACA,wEAAwE;AACxE;EACE,oBAAoB;AACtB;;AAEA;EACE,oBAAoB;EACpB,UAAU;EACV,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,QAAQ;EACR,0BAA0B;EAC1B,YAAY;EACZ,6BAA6B;EAC7B,gBAAgB;EAChB,eAAe;EACf,yBAAyB;EACzB,8BAA8B;EAC9B,iCAAiC;AACnC;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,8CAA8C;EAC9C,aAAa;EACb,kDAAkD;EAClD,WAAW;AACb;;AAEA;EACE,eAAe;EACf,eAAe;EACf,kBAAkB;EAClB,oBAAoB;EACpB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,WAAW;EACX,oBAAoB;EACpB,oBAAoB;EACpB,qBAAqB;EACrB,4CAA4C;EAC5C,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,qBAAqB;EACrB,oBAAoB;AACtB;AACA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,eAAe;AACjB;;AAEA,wEAAwE;AACxE;EACE,oBAAoB;AACtB;;AAEA;EACE,8BAA8B;EAC9B,0FAA0F;EAC1F,qBAAqB;EACrB,mBAAmB;EACnB,0CAA0C;EAC1C,aAAa;EACb,uDAAuD;EACvD,iBAAiB;EACjB,mBAAmB;EACnB,SAAS;EACT,YAAY;EACZ,6BAA6B;AAC/B;;AAEA;EACE,4CAA4C;AAC9C;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,YAAY;EACZ,WAAW;EACX,4CAA4C;EAC5C,oCAAoC;EACpC,eAAe;EACf,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;EACpC,oCAAoC;EACpC,YAAY;AACd;;AAEA;EACE,oCAAoC;EACpC,4CAA4C;EAC5C,oCAAoC;AACtC;;AAEA;EACE,4CAA4C;EAC5C,UAAU;EACV,YAAY;EACZ,qBAAqB;EACrB,8CAA8C;EAC9C,sDAAsD;EACtD,mDAAmD;EACnD,aAAa;EACb,qCAAqC;EACrC,kCAAkC;EAClC,oCAAoC;EACpC,eAAe;EACf,qBAAqB;EACrB,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,eAAe;EACf,gBAAgB;EAChB,yBAAyB;EACzB,8BAA8B;EAC9B,iCAAiC;AACnC;;AAEA;EACE,qBAAqB;EACrB,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,gBAAgB;EAChB,yBAAyB;EACzB,8BAA8B;EAC9B,iCAAiC;AACnC;;AAEA;EACE,qBAAqB;EACrB,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,oBAAoB;EACpB,mBAAmB;EACnB,aAAa;EACb,qCAAqC;EACrC,kCAAkC;EAClC,kBAAkB;EAClB,4CAA4C;EAC5C,0BAA0B;EAC1B,wBAAwB;EACxB,UAAU;EACV,oDAAoD;EACpD,qBAAqB;EACrB,sDAAsD;EACtD,8DAA8D;EAC9D,2DAA2D;AAC7D;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,iCAAiC;EACjC,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,eAAe;EACf,oCAAoC;AACtC;;AAEA;EACE,iBAAiB;EACjB,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,YAAY;EACZ,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,qBAAqB;EACrB,YAAY;EACZ,sBAAsB;AACxB;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,yBAAyB;EACzB,oCAAoC;AACtC;;AAEA;EACE,kBAAkB;EAClB,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,YAAY;EACZ,qBAAqB;AACvB;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,YAAY;EACZ,qBAAqB;AACvB;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,gBAAgB;EAChB,eAAe;EACf,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,YAAY;EACZ,YAAY;EACZ,qBAAqB;AACvB;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,YAAY;EACZ,qBAAqB;EACrB,wCAAwC;EACxC,YAAY;EACZ,iBAAiB;EACjB,qBAAqB;AACvB;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,YAAY;EACZ,qBAAqB;EACrB,YAAY;EACZ,iBAAiB;EACjB,qBAAqB;EACrB,4BAA4B;AAC9B;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;AACA;EACE,eAAe;EACf,YAAY;EACZ,WAAW;EACX,yBAAyB;EACzB,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;EAChB,WAAW;AACb;;AAEA;EACE,kBAAkB;AACpB","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap\");\n\n* {\n  margin: 0;\n  box-sizing: border-box;\n}\n\n:root {\n  --header-bg-color: rgb(197, 84, 67);\n  --header-title-color: rgb(255, 255, 255);\n  --side-panel-bg-color: rgb(250, 250, 250);\n  --main-content-bg-color: rgb(254, 254, 254);\n  --side-panel-items-color: rgb(110, 110, 110);\n  font-family: \"Roboto\", sans-serif;\n}\n\nbody {\n  height: 100vh;\n  width: 100vw;\n  position: relative;\n  display: grid;\n  grid-template-rows: 0.07fr 1fr;\n  grid-template-columns: 0.3fr 1fr;\n}\n\n.hidden {\n  opacity: 0;\n}\n\n.header {\n  grid-row: 1 / 2;\n  grid-column: 1 / 3;\n  color: var(--header-title-color);\n  height: 100%;\n  background-color: var(--header-bg-color);\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n}\n\n.header > h1 {\n  margin-left: 1rem;\n}\n\n.side-panel {\n  grid-row: 2 / 3;\n  grid-column: 1 / 2;\n  width: 100%;\n  height: 100%;\n  padding: 1rem 0 0 1rem;\n  background-color: var(--side-panel-bg-color);\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n.side-panel > ul {\n  font-size: 1em;\n  list-style: none;\n  font-weight: 500;\n  width: 100%;\n  padding: 0;\n}\n\n#addProjectButton {\n  margin-top: 2rem;\n}\n\n#projectHeader {\n  margin: 0.5rem 0 0 0;\n  text-align: center;\n}\n\n#projectLi {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin: 0.5rem 0 0 0;\n  width: 100%;\n  font-size: 1.2em;\n  cursor: pointer;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n#projectLi:hover {\n  width: 100%;\n  background-color: rgb(236, 236, 236);\n  border-radius: 1rem;\n}\n\n#projectLi:active {\n  background-color: rgb(216, 216, 216);\n}\n\n#projectLi > span {\n  opacity: 20%;\n  position: relative;\n  top: 2px;\n  right: 2px;\n  align-self: flex-end;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n#projectLi > span:hover {\n  opacity: 100%;\n  position: relative;\n  top: 2px;\n  right: 2px;\n  align-self: flex-end;\n}\n/* Fixes a bug where the click event fires on children of deletebutton */\n#projectLi > span > * {\n  pointer-events: none;\n}\n\n.side-panel-button {\n  margin: 0.5rem 0 0 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 5px;\n  transform-origin: left top;\n  border: none;\n  background-color: transparent;\n  font-size: 1.1em;\n  cursor: pointer;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n.side-panel-button:hover {\n  transform: scale(1.1);\n}\n\n.side-panel-button:active {\n  font-size: 1.1em;\n  color: rgb(179, 179, 179);\n}\n\n.main-content {\n  grid-row: 2 / 3;\n  grid-column: 2 / 3;\n  background-color: var(--main-content-bg-color);\n  display: grid;\n  grid-template-rows: 100px repeat(auto-fit, 4.5rem);\n  width: 100%;\n}\n\n.main-content > h2 {\n  font-size: 2rem;\n  grid-row: 1 / 2;\n  grid-column: 1 / 2;\n  justify-self: center;\n  margin-top: 0.5rem;\n}\n\n.main-content > button {\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n  height: 30px;\n  width: 80px;\n  justify-self: center;\n  align-self: flex-end;\n  border-radius: 0.5rem;\n  background-color: var(--side-panel-bg-color);\n  font-weight: bold;\n}\n\n#task > input[type=\"text\"] {\n  grid-column: 2 / 3;\n  position: absolute;\n  border-radius: 0.2rem;\n  padding-left: 0.5rem;\n}\n#task > input[type=\"date\"] {\n  grid-column: 3/4;\n  position: absolute;\n  right: 70px;\n}\n\n#task > h3 {\n  width: max-content;\n  cursor: pointer;\n  align-self: center;\n  position: relative;\n}\n\n#task > #taskDate {\n  width: max-content;\n  cursor: pointer;\n}\n\n#task > #taskDeleteButton {\n  height: 24px;\n  cursor: pointer;\n}\n\n/* Fixes a bug where the click event fires on children of deletebutton */\n#taskDeleteButton > * {\n  pointer-events: none;\n}\n\n#task {\n  background: rgb(255, 255, 255);\n  background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, rgba(250, 250, 250, 1) 42%);\n  border-radius: 0.5rem;\n  margin: 0.5rem 4rem;\n  border: 1px solid rgba(128, 128, 128, 0.1);\n  display: grid;\n  grid-template-columns: 1em auto max-content max-content;\n  padding: 0 0.5rem;\n  align-items: center;\n  gap: 10px;\n  height: 4rem;\n  transition: all linear 0.5sec;\n}\n\n#task:hover {\n  background-color: rgba(228, 228, 228, 0.462);\n}\n\n.hide {\n  display: none;\n}\n\n#addTaskButton {\n  grid-row: 1 / 2;\n  grid-column: 1 / 2;\n  height: 50px;\n  width: 50px;\n  background-color: var(--side-panel-bg-color);\n  color: var(--side-panel-items-color);\n  font-size: 3rem;\n  border-radius: 50%;\n  margin: 1rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: 1px solid rgb(216, 216, 216);\n}\n\n#addTaskButton:hover {\n  border: 1px solid rgb(121, 121, 121);\n  background-color: rgb(149, 149, 149);\n  color: white;\n}\n\n#addTaskButton:active {\n  border: 1px solid rgb(216, 216, 216);\n  background-color: var(--side-panel-bg-color);\n  color: var(--side-panel-items-color);\n}\n\n.todo-item {\n  background-color: var(--side-panel-bg-color);\n  width: 80%;\n  height: auto;\n  border-radius: 0.5rem;\n  box-shadow: 3px 3px 9px 0px rgba(0, 0, 0, 0.5);\n  -webkit-box-shadow: 3px 3px 9px 0px rgba(0, 0, 0, 0.5);\n  -moz-box-shadow: 3px 3px 9px 0px rgba(0, 0, 0, 0.5);\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(3, 1fr);\n  color: var(--side-panel-items-color);\n  padding: 0.5rem;\n  margin: 0 auto 0 auto;\n  overflow: hidden;\n  margin-top: 0.5rem;\n}\n\n.todo-item:hover {\n  background-color: rgb(255, 255, 255);\n}\n\n.todo-item > h3 {\n  color: black;\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n}\n\n.todo-item > p:nth-child(2) {\n  grid-column: 1 / 2;\n  grid-row: 2 / 4;\n}\n\n.todo-item > p:nth-child(3) {\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  text-align: end;\n}\n\n.todo-item > p:nth-child(4) {\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  text-align: end;\n}\n\n.todo-item > p:nth-child(5) {\n  height: 24px;\n  width: 24px;\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  margin-left: 80%;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n.todo-item > p:nth-child(5):hover {\n  transform: scale(1.1);\n  color: rgb(49, 49, 49);\n}\n\n.todo-item > p:nth-child(5):active {\n  font-size: 1.1em;\n  color: rgb(179, 179, 179);\n}\n\n.todo-item > p:nth-child(6) {\n  width: 24px;\n  height: 24px;\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  margin-left: 90%;\n  transition: all 0.5s ease;\n  -moz-transition: all 0.5s ease;\n  -webkit-transition: all 0.5s ease;\n}\n\n.todo-item > p:nth-child(6):hover {\n  transform: scale(1.1);\n  color: rgb(49, 49, 49);\n}\n\n.todo-item > p:nth-child(6):active {\n  font-size: 1.1em;\n  color: rgb(179, 179, 179);\n}\n\n.todo-item > p > svg {\n  fill: green;\n}\n\n.form-container {\n  --form-height: 300px;\n  --form-width: 625px;\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(2, 1fr);\n  position: absolute;\n  background-color: var(--side-panel-bg-color);\n  height: var(--form-height);\n  width: var(--form-width);\n  top: 200px;\n  right: calc(100vw / 2 - calc(var(--form-width) / 2));\n  border-radius: 0.5rem;\n  box-shadow: 8px 7px 14px 0px rgba(133, 133, 133, 0.75);\n  -webkit-box-shadow: 8px 7px 14px 0px rgba(133, 133, 133, 0.75);\n  -moz-box-shadow: 8px 7px 14px 0px rgba(133, 133, 133, 0.75);\n}\n\nform {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: 0.5fr 1fr 1fr;\n  grid-row: 1 / 3;\n  grid-column: 1 / 3;\n}\n\nform > h2 {\n  margin: 1rem 1rem;\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n  color: var(--side-panel-items-color);\n}\n\nform > input[type=\"text\"] {\n  font-size: 1.2rem;\n  border-radius: 0.5rem;\n  border: none;\n  padding-left: 1rem;\n  width: 300px;\n  height: 50px;\n  grid-column: 1 / 2;\n  grid-row: 2 / 3;\n  margin-left: 1rem;\n}\n\nform > input[type=\"text\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > textarea {\n  resize: none;\n  grid-column: 1 / 2;\n  grid-row: 3 / 4;\n  height: 150px;\n  margin: 0 0 1rem 1rem;\n  border: none;\n  padding: 1rem 0 0 1rem;\n}\n\nform > textarea:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > label {\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  margin: 1.5rem 0 0 3.5rem;\n  color: var(--side-panel-items-color);\n}\n\nform > input[type=\"date\"] {\n  padding-left: 1rem;\n  border-radius: 0.5rem;\n  border: none;\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  height: 35px;\n  width: 150px;\n  margin: 1rem 0 0 8rem;\n}\n\nform > input[type=\"date\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > input[name=\"urgency\"] {\n  border-radius: 0.5rem;\n  border: none;\n  padding-left: 1rem;\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  height: 35px;\n  width: 150px;\n  margin: 0rem 0 0 8rem;\n}\n\nform > input[name=\"urgency\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\nform > input[name=\"parentProject\"] {\n  grid-column: 2/3;\n  grid-row: 2 / 3;\n  border-radius: 0.5rem;\n  border: none;\n  padding-left: 1rem;\n  height: 35px;\n  width: 150px;\n  margin: 3rem 0 0 8rem;\n}\n\nform > input[name=\"parentProject\"]:hover {\n  border: 1px solid rgba(128, 128, 128, 0.8);\n}\n\n#submit-button {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  height: 35px;\n  width: 150px;\n  margin: 3rem 0 0 8rem;\n  background-color: var(--header-bg-color);\n  color: white;\n  font-size: 1.1rem;\n  border-radius: 0.5rem;\n}\n\n#submit-button:hover {\n  background-color: rgb(59, 180, 93);\n}\n\nform > input[type=\"button\"] {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  height: 35px;\n  width: 150px;\n  margin: 6rem 0 0 8rem;\n  color: black;\n  font-size: 1.1rem;\n  border-radius: 0.5rem;\n  background-color: whitesmoke;\n}\n\nform > input[type=\"button\"]:hover {\n  background-color: rgb(180, 48, 48);\n}\n\n.project-input {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n#projectInputField {\n  font-size: 1rem;\n  height: 2rem;\n  width: 100%;\n  margin: 0.5rem 0 0.5rem 0;\n  padding: 0 0 0 1rem;\n}\n\n.side-panel > ul:nth-child(1) {\n  margin-top: 2rem;\n  height: 25%;\n}\n\n.side-panel > ul > li {\n  margin-top: 0.5rem;\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/components/date_handler.js":
/*!****************************************!*\
  !*** ./src/components/date_handler.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DateHandler)
/* harmony export */ });
...
class DateHandler {
  static todaysDate() {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "yyyy/MM/dd");
  }

  static formatDate(date) {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, "yyyy/MM/dd");
  }
  ...
  static taskDueThisWeek(date) {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(this.parsedDate(date), { weekStartsOn: 1 });
  }

  static taskDueToday(date) {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(this.parsedDate(date));
  }
}
...
/***/ "./src/components/local_storage.js":
/*!*****************************************!*\
  !*** ./src/components/local_storage.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _date_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./date_handler */ "./src/components/date_handler.js");
/* harmony import */ var _local_storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./local_storage */ "./src/components/local_storage.js");
...
class SiteContent {
  ...
  static loadProjectsFromStorage() {
    ...
    return _projects__WEBPACK_IMPORTED_MODULE_2__["default"].setProjectList(_local_storage__WEBPACK_IMPORTED_MODULE_1__["default"].loadProjects());
  }
  ...
  static loadTodosFromStorage() {
    ...
    return _todo__WEBPACK_IMPORTED_MODULE_3__["default"].setUnfinishedTasks(_local_storage__WEBPACK_IMPORTED_MODULE_1__["default"].loadTodos());
  }
  ...
  static constructProjectList() {
    ...
    const projects = _projects__WEBPACK_IMPORTED_MODULE_2__["default"].getProjectList();
  ...
  static initRemoveProjectButtons() {
    ...
    removeProjectButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        _projects__WEBPACK_IMPORTED_MODULE_2__["default"].removeProject(targetID);
        this.renderProjectList();
        this.setContentTitle();
        _local_storage__WEBPACK_IMPORTED_MODULE_1__["default"].saveProjects(_projects__WEBPACK_IMPORTED_MODULE_2__["default"].getProjectList);
      });
    });
  }
  ...
  static createNewProject(name) {
    const project = new _projects__WEBPACK_IMPORTED_MODULE_2__["default"](name);
  ...
  static appendToProjectArray(project) {
    _projects__WEBPACK_IMPORTED_MODULE_2__["default"].appendToProjectList(project);
  }
  ...
  // Create new todos
  static createTask() {
    const task = new _todo__WEBPACK_IMPORTED_MODULE_3__["default"]("Click to set title", this.activeView);
    _todo__WEBPACK_IMPORTED_MODULE_3__["default"].appendToCollection(task);
  }
  ...
  static taskEventListeners() {
    ...
    inputTitle.forEach((t) => {
      t.addEventListener("keypress", (e) => {
        if (e.key === "Enter") {
          const task = _todo__WEBPACK_IMPORTED_MODULE_3__["default"].getUniqueTask(e);
          const v = t.value;
          task.setTitle(v);
          this.renderMainContent();
          t.classList.add("hide");
          _local_storage__WEBPACK_IMPORTED_MODULE_1__["default"].saveTodos(_todo__WEBPACK_IMPORTED_MODULE_3__["default"].getUnfinishedTasks());
        }
      });
    });
    ...
    inputDate.forEach((t) => {
      t.addEventListener("keypress", (e) => {
        if (e.key === "Enter") {
          const task = _todo__WEBPACK_IMPORTED_MODULE_3__["default"].getUniqueTask(e);
          const v = _date_handler__WEBPACK_IMPORTED_MODULE_0__["default"].formatDate(new Date(t.value));
          task.setDueDate(v);
          this.renderMainContent();
          t.classList.add("hide");
          _local_storage__WEBPACK_IMPORTED_MODULE_1__["default"].saveTodos(_todo__WEBPACK_IMPORTED_MODULE_3__["default"].getUnfinishedTasks());
    ...
    deleteBtn.forEach((t) => {
      t.addEventListener("click", (e) => {
        _todo__WEBPACK_IMPORTED_MODULE_3__["default"].deleteTask(e);
        this.renderMainContent();
        _local_storage__WEBPACK_IMPORTED_MODULE_1__["default"].saveTodos(_todo__WEBPACK_IMPORTED_MODULE_3__["default"].getUnfinishedTasks());
      });
    });
  ...
  static createDOMElementsFromTodos() {
    ...
    let list = _todo__WEBPACK_IMPORTED_MODULE_3__["default"].unfinishedTasks;
    if (this.activeView !== "All tasks") {
      list = _todo__WEBPACK_IMPORTED_MODULE_3__["default"].unfinishedTasks.filter((p) => p.project === this.activeView);
    }
    if (this.activeView === "Week") {
      list = _todo__WEBPACK_IMPORTED_MODULE_3__["default"].unfinishedTasks.filter((p) => _date_handler__WEBPACK_IMPORTED_MODULE_0__["default"].taskDueThisWeek(p.dueDate));
    }

    if (this.activeView === "Today") {
      list = _todo__WEBPACK_IMPORTED_MODULE_3__["default"].unfinishedTasks.filter((p) => _date_handler__WEBPACK_IMPORTED_MODULE_0__["default"].taskDueToday(p.dueDate));
    }
    list.forEach((task) => {
      // Main div
...
class Todo {
  ...
  constructor(title, project) {
    ...
    this.title = title;
    this.dueDate = _date_handler__WEBPACK_IMPORTED_MODULE_0__["default"].todaysDate();
